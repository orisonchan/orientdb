...
public class ODirectoryPage extends ODurablePage {
  ...
  public final OCacheEntry getEntry() {
    return entry;
  }

  final void setMaxLeftChildDepth(final int localNodeIndex, final byte maxLeftChildDepth) {
  ...
  final void setMaxRightChildDepth(final int localNodeIndex, final byte maxRightChildDepth) {
  ...
  final void setNodeLocalDepth(final int localNodeIndex, final byte nodeLocalDepth) {
  ...
  final void setPointer(final int localNodeIndex, final int index, final long pointer) {
