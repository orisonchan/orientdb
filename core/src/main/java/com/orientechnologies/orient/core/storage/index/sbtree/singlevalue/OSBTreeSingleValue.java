 ...
 * @since 8/7/13
 */
public final class OSBTreeSingleValue<K> extends ODurableComponent {
  ...
  public long size() {
    ...
    try {
      ...
      try {
        ...
        try {
          final OSBTreeBucketSingleValue<K> rootBucket = new OSBTreeBucketSingleValue<>(rootCacheEntry, keySerializer, keyTypes,
              encryption);
