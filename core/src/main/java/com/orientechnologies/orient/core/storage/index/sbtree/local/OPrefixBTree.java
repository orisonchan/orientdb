...
public class OPrefixBTree<V> extends ODurableComponent {
  ...
  public boolean validatedPut(String key, V value, OBaseIndexEngine.Validator<String, V> validator) throws IOException {
    return put(key, value, validator);
  }

  private boolean put(String key, V value, OBaseIndexEngine.Validator<String, V> validator) throws IOException {
