...
public class OClusterPositionMapUndoRemoveSerializationTest {
  @Test
  public void testStreamSerialization() {
    ...
    final int index = 65;
    final int recordPageIndex = 37;
    final int recordPosition = 73;

    OClusterPositionMapUndoRemove operation = new OClusterPositionMapUndoRemove(index, recordPageIndex, recordPosition);
    ...
    OClusterPositionMapUndoRemove restoredOperation = new OClusterPositionMapUndoRemove();
